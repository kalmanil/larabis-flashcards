            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                ...
                <form action="{{ route('flashcards.words.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="shoresh_root" id="shoresh_root" value="{{ old('shoresh_root') }}" placeholder="e.g. שלמ" dir="rtl" class="w-full border border-gray-200 rounded-xl px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="transcription_ru" id="transcription_ru" value="{{ old('transcription_ru') }}" class="flex-1 border border-gray-200 rounded-xl px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
