...
use App\Features\Auth\Controllers\Admin\LoginController;
use App\Features\Auth\Controllers\Admin\SocialAuthController;
...
Route::middleware('auth')->prefix('dashboard')->name('flashcards.')->group(function () {
    ...
    Route::post('/words/create-ru', [WordController::class, 'storeFromRussian'])->name('words.store-from-russian');
