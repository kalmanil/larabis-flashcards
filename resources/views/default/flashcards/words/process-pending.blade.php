            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                ...
                <form action="{{ route('flashcards.words.update', $word) }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="form_text" id="form_text" value="{{ old('form_text', $word->form_text) }}" required dir="rtl" readonly
                                   class="flex-1 border border-gray-200 rounded-xl px-3 py-2 text-lg bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="flex flex-wrap gap-3 pt-2">
                        <button type="submit" name="enrichment_flow" value="1" class="px-6 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl font-medium hover:from-indigo-600 hover:to-purple-700 shadow-md transition-all duration-200">Save and continue</button>
                        <button type="submit" class="px-6 py-2 border border-gray-200 rounded-xl hover:bg-gray-50 font-medium transition-colors">Save and exit</button>
                        <a href="{{ route('flashcards.dashboard') }}" class="px-6 py-2 border border-gray-200 rounded-xl hover:bg-gray-50 font-medium transition-colors">Exit without saving</a>
                    </div>
                </form>
            </div>
        </div>
