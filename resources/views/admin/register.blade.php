...
@section('title', 'Register - Flashcards')
    ...
    <div class="max-w-md w-full space-y-8 relative z-10">
        ...
        <div class="text-center">
            ...
            <p class="text-indigo-200 text-sm font-medium">
                Join {{ $config['name'] ?? 'Flashcards' }} today
            </p>
        </div>
            ...
            <form class="space-y-6" action="{{ route('register') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="name" name="name" type="text" autocomplete="name" required 
                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 text-gray-900 placeholder-gray-400 @error('name') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="email" autocomplete="email" required 
                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 text-gray-900 placeholder-gray-400 @error('email') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" autocomplete="new-password" required 
                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 text-gray-900 placeholder-gray-400 @error('password') border-red-500 @enderror"
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('login.form') }}" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-200">
                            Sign in
                        </a>
                    </p>
                </div>
